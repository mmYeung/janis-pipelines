...
class WGSSomaticMultiCallersVariantsOnly(WGSSomaticGATKVariantsOnly):
    ...
    def add_inputs_for_intervals(self):
        ...
        self.input(
            "vardict_intervals", Array(Bed), doc=INPUT_DOCS["vardict_intervals"]
        )
        self.input(
            "strelka_intervals", BedTabix, doc=INPUT_DOCS["strelka_intervals"]
        )
    ...
    def add_vardict_variantcaller(self, normal_bam_source, tumor_bam_source):
        ...
        self.step(
            ...
            BcfToolsSort_1_9(
                vcf=self.vc_vardict_merge.out.as_type(CompressedVcf)
            ),
        )
        self.step(
    ...
    def add_combine_variants(self, normal_bam_source, tumor_bam_source):
        ...
        self.step(
            "combined_compress", BGZipLatest(file=self.combine_variants.out)
        )
        self.step(
            "combined_sort",
            BcfToolsSort_1_9(
