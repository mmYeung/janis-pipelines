...
class CaptureSomaticValidationVariantsOnlyMultiSample(BioinformaticsWorkflow):
    def id(self):
        return "CaptureSomaticValidationVariantsOnlyMultiSample"

    def friendly_name(self):
        return "Capture Somatic Validation Variants Only (MultiSample)"
