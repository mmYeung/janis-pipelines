...
from janis_bioinformatics.data_types import BamBai, FastaWithDict, Bed, VcfTabix
...
class CaptureSomaticTumourOnlyUMIMultiSampleVariantOnly(BioinformaticsWorkflow):
    def id(self):
        return "CaptureSomaticTumourOnlyUMIMultiSampleVariantOnly"

    def friendly_name(self):
        return "Capture Somatic Tumour Only with UMIs (Multi callers) Variants Only"
    ...
    def constructor(self):
        ...
        self.capture_outputs_from_step(self.capture_multicaller)
